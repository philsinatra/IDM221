...
- Review "modern" browsers
- Introduce HTML
- Introduce CSS
- Review tools used for web development
- Discuss documentation for development projects
...
![fit](images/web-app-components.png)
...
![right fit](images/ss-apple-dot-com.png)

![left 50%](images/static-page-process.png)
...
![right fit](images/ss-amazon-dot-com.png)

![left 50%](images/dynamic-page-process.png)

^ A dynamic web page is a web page that is generated by a server-side program or script each time the page is requested. This diagram shows the process.
...
- [Blue Host](https://www.bluehost.com/track/philsinatra)
