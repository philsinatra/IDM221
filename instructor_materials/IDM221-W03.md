...
^ When you create a link that contains text, the text should clearly indicate the function of the link. For example, you should not use text like "click here" because it does not indicate what the link does. Instead, you should use text like that in the examples. If you can't tell what a link does by reading it's text, you should rewrite the text. This improves the accessibility of your site, and help search engines index your site.
