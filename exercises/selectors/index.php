  ...
  <main role="main">
    <div class="container">
      ...
      <section>
        ...
        <p>Using the above sample code, program a CSS selector that will style the <code>h1</code> element <span style="color: red">red</span>.</p>
        <div class="kc_text">
      ...
      <section>
        <h2>Exercise 1</h2>
        <pre class="prettyprint">&lt;body&gt;&NewLine;  &lt;h1&gt;Hello World&lt;/h1&gt;&NewLine;  &lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit.&lt;/p&gt;&NewLine;&lt;/body&gt;</pre>
        <p>Using the above sample code, program a CSS selector that will style the <code>p</code> element, setting the font size to 18px.</p>
        <div class="kc_text">
          <div class="kc_text__input">
      ...
      <section>
        ...
        <p>Using the above sample code, program a CSS selector that will style <b>only</b> the element that has an <code>id</code> equal to "introduction", setting the the color to the hex code <span style="color: #990000">990000</span>.</p>
        <div class="kc_text">
          <div class="kc_text__input">
      ...
      <section>
        ...
        <p>Using the above sample code, program a CSS selector that will style <b>all</b> the elements that have a <code>class</code> equal to "primary", setting the the color to an rgb code that has <span style="color: rgb(5,100,50)">5 red, 50 blue and 100 green</span>.</p>
        <div class="kc_text">
          <div class="kc_text__input">
      ...
      <section>
        <h2>Exercise 7</h2>
        <p>Program a CSS selector that will set the color of all <code>h1</code>, <code>h2</code>, and <code>h3</code> elements to hex code <span style="color: #0da3f2">0da3f2</span>.</p>
        <div class="kc_text">
          <div class="kc_text__input">
      ...
      <section>
        ...
        <p>Using the above sample code, program a CSS selector that sets the font size for all of the list items in lists with a <code>class</code> of <i>speakers</i> to 18px. </p>
        <div class="kc_text">
          <div class="kc_text__input">
      ...
      <section>
        ...
        <p>I need help styling some links. Program three CSS selectors:</p>
        <ol>
